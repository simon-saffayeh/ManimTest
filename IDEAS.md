...
When asked to "build another", take one of these (or propose something in the same spirit) and
say which you picked before starting. Tick it off and move it to Done.
...
- [x] `nines` — 0.999... = 1. 40.8s
- [x] `monty` — Monty Hall, always switch. 39.0s
